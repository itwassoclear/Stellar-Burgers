    ...
    <div className={ clsx(styles.modal, "pl-10 pr-10 pt-10 pb-15") }>
      ...
      <div className={ styles.details }>
        <p className={ clsx(styles.text, textDefaultClass) }>
          Калории, ккал<strong className={ clsx(textMeduimClass, "mt-2") }>{ details.calories }</strong>
        </p>
        <p className={ clsx(styles.text, textDefaultClass) }>
          Белки, г<strong className={ clsx(textMeduimClass, "mt-2") }>{ details.proteins }</strong>
        </p>
        <p className={ clsx(styles.text, textDefaultClass) }>
          Жиры, г<strong className={ clsx(textMeduimClass, "mt-2") }>{ details.fat }</strong>
        </p>
        <p className={ clsx(styles.text, textDefaultClass) }>
          Углеводы, г<strong className={ clsx(textMeduimClass, "mt-2") }>{ details.carbohydrates }</strong>
        </p>
      </div>
    </div>
  );
